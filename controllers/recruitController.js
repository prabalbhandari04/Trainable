...
const userCtrl = {
    ...
    activateEmail: async (req, res) => {
        try {
            ...
            const check = await Recruiters.findOne({email})
    ...
    resetPassword: async (req, res) => {
        try {
            ...
            // update password
            await Recruiters.findOneAndUpdate({_id: req.user.id}, {
    ...
    getUserInfo: async (req, res) => {
        try {
            const user = await Recruiters.findById(req.user.id).select('-password')
